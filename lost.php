    ...
    <div class="request-table">
        <div class="request-container book-container" id="printTable" style="max-width: 1600px;">
            <div class="student-table-header">
                <h2 class="request-title student-info-title">List of Lost books</h2>
		...
		{
            $var1='<p class="lost-pill">LOST</p>';
			$q = mysqli_query($db, "
                SELECT issueid, duedate, student.studentid, fname, lrn, acessionnum, studentpic, books.bookid, bookname, ISBN, price, bookpic, authors.authorname, category.categoryname, issueinfo.issuedate, duedate, approve, fine 
                FROM student 
                ...
                WHERE (issueinfo.approve = '$var1') 
                AND lrn = '$_POST[search]' 
                ORDER BY issueinfo.returndate ASC;
            ");
			if(mysqli_num_rows($q)==0)
			{
				echo "Sorry! There's no lost book by this student ID";
