...
<body>
    ...
    if(isset($_SESSION['login_emp_username']))
    {
        ...
        $r=mysqli_query($db,"SELECT COUNT(status) as total FROM message where status='no' and username='$_SESSION[login_emp_username]' and sender='admin';");
        ...
        <div class="container">
            <div class="navbar">
                ...
                <a href="index.php"><h3 style="font-size: 15px;">Dela Paz National High School Library</h3></a>
                </div>
                <div class="student-navbar">
                    ...
                    <script>
                        ...
                        <li><a href="employee_books.php" >Books</a></li>
                        <li><a href="employee_issue_info.php" >Issue Info</a></li>
                        <li><a href="employee_borrow.php" >Borrow History</a></li>
                        <!-- <li><a href="">About Us</a></li> -->
                        <?php if(isset($_SESSION['type']) && $_SESSION['type'] == 1){ ?> <li><a href="student_manage_books.php">Manage Books</a></li> <?php } ?>
                        ...
                        <li class="dropdown">
                            ...
                            <?php
                                ...
                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$_SESSION['login_emp_username'];
