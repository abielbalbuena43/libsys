...
<body>
    <div class="request-table">
        <div class="request-container">
            <div class="student-qr">
                ...
                <!-- <a href="via_qr.php?action=request"><button>Request via QR</button></a> -->
            </div>
            <?php
                ...
                while($row=mysqli_fetch_assoc($q))
                {
                    ...
                    <div class='table-info'>
                        ...
                        <div>
                            ...
                            <small>Price: ";echo $row['price'];echo" ₱</small><br>";?>
    ...
    if(isset($_GET['req']))
	{
        ...
        logger($db, $_SESSION['userid'], '0', 'Deleted book request with id "'.$id.'"');
