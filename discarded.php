    ...
    <div class="request-table">
        <div class="request-container book-container" id="printTable" style="max-width: 1600px;">
            <div class="student-table-header">
                <h2 class="request-title student-info-title">List of Discarded books</h2>
		...
		{
            $var1='<p class="discarded-pill">DISCARDED</p>';
			$q = mysqli_query($db, "
			...
			{
				echo "Sorry! There's no discarded book by this student ID";
		...
		else
		{
			...
			{
				echo "There's no discarded books.";
			}
            else{
                echo "<table class='rtable booktable'>";
            echo "<tr style='background-color: #1aa7ec;'>";
