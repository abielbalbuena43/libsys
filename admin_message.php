...
<body style="width: 100vw; background-color:#1aa7ec; ">
    <?php
    $sql1=mysqli_query($db,"SELECT student.studentpic,fname,lname,message.username,message from student inner join message on student.student_username=message.username group by username order by message.status;");
                ...
                <?php
                    ...
                    while($res1=mysqli_fetch_assoc($sql1)){
                        ...
                        <div class='table-info'>
                            ...
                            <div>
                                <p>";echo $res1['fname'] . ' ' . $res1['lname'];echo"</p>";
                                // echo"<small>";echo $res1['fname']; echo " sent ";echo $res1['total']; echo" messages";echo"</small>";
    ...
    <div class="right-box">
        <div class="right-box2">
            ...
            if(isset($_GET['req'])){
                ...
                $sql1=mysqli_query($db,"SELECT student.studentpic,fname from student where student_username = '$_SESSION[stdusername]';");
                $sql2=mysqli_query($db,"SELECT * FROM message where username = '$_SESSION[stdusername]';");
                while($row=mysqli_fetch_assoc($sql1)){
                    ?>
                    <div style="height: 70px; width:100%; text-align:center; background-color: #1aa7ec; color:white; padding-top:8px;display:flex;">
                    <?php echo "<img height=60px width=60px style='border-radius: 50%;margin-left:260px;' src='images/".$row['studentpic']."'>"?>
                    <h3 style="padding-top:10px;padding-left:10px;"><?php echo  $row['fname']?></h3>
                    </div>
                    <?php
                }
                ?>
                <div class="msg-text" style="height:520px;">
            <?php
            ...
            <?php
                ...
                ?>
                <div class="msg-text" style="height:580px;">
            <?php
